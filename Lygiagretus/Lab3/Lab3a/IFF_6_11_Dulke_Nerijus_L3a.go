...
const RezultatuFailas string = "IFF_6_11_Dulke_Nerijus_L3a_rez.txt"
...
func main() {
	...
	go valdytojas(valdymoKanalas, duomenuKanalas, trynimoPabaigosKanalai)
	<-pabaigosKanalas
}
...
// valdytojas
func valdytojas(valdymoKanalas <-chan Zinute, duomenuSkirstymas chan<- []AutoStruktura, trynimoPabaigosKanalai []chan bool) {
	...
	for baigusiuPirkejuKiekis != N || baigusiuSalonuKiekis != N {
		var zinute = <-valdymoKanalas

		if strings.Compare(zinute.tipas, tPrideti) == 0 {
			rezultatai, rezultatuKiekis, baigusiuSalonuKiekis = prideti(
				rezultatai,
				zinute,
				rezultatuKiekis,
				baigusiuSalonuKiekis)
		} else {
			rezultatai, rezultatuKiekis, baigusiuSalonuKiekis, arPirkejasApsipirko, baigusiuPirkejuKiekis = salinti(
				rezultatai,
				zinute,
				rezultatuKiekis,
				baigusiuSalonuKiekis,
				arPirkejasApsipirko,
				trynimoPabaigosKanalai,
